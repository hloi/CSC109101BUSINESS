...
int main() {
    ...
    Business* b1 = new Business("QCC", "670 West Boylston street, Worcester, MA 01606");

    Restaurant* r1 = new Restaurant("Roy Rogers", "444 Park ave., Worcester, MA 01606", 5, 20);
...
//    r1.SetSeating(100);
    ...
    CoffeeShop* co = new CoffeeShop("News", "20 Main st., Worcester, MA 01606");
    co->Print();

    cout << co->GetDescription() << endl;

    Stand* std1 = new Stand("Quilt shop", "Floor 2", 5);
